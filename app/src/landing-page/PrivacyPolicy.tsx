...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 leading-relaxed">
      <h1 className="text-3xl font-bold text-gray-800 dark:text-white border-b-2 border-gray-800 dark:border-white pb-2 mb-6">Privacy Policy</h1>
      <p className="mb-6">
      ...
      <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 mt-8 mb-4">1. Information We Collect</h2>
      
      <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-300 mt-6 mb-2">Personal Information</h3>
      ...
      <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-300 mt-6 mb-2">Non-Personal Information</h3>
      ...
      <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-300 mt-6 mb-2">Cookies and Tracking</h3>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 mt-8 mb-4">2. How We Use Your Information</h2>
      ...
      <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 mt-8 mb-4">3. Sharing Your Information</h2>
      ...
      <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 mt-8 mb-4">4. Data Security</h2>
      ...
      <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 mt-8 mb-4">5. Your Data Protection Rights</h2>
      ...
      <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 mt-8 mb-4">6. Updates to This Policy</h2>
      <p className="mb-4">
        We may update this policy periodically. Please review it regularly to stay informed about how we protect your information.
      </p>

      <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 mt-8 mb-4">7. Contact Us</h2>
