...
export default function Clients() {
  ...
  return (
    <div className='mt-12 mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-between gap-y-6 '>
      ...
      <div className='mx-auto grid max-w-lg grid-cols-3 items-center gap-x-6 gap-y-12 sm:max-w-xl md:grid-cols-3 lg:grid-cols-6 sm:gap-x-10 sm:gap-y-14 lg:mx-0 lg:max-w-none mb-12' >
