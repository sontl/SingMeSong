...
const TermsOfService: React.FC = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 leading-relaxed">
      ...
      <h2 className="text-2xl font-semibold text-gray-700 mt-8 mb-4">2. Changes to Terms</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold text-gray-700 mt-8 mb-4">3. Use of Services</h2>
      <h3 className="text-xl font-semibold text-gray-600 mt-6 mb-2">Eligibility</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold text-gray-600 mt-6 mb-2">Account Registration</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold text-gray-600 mt-6 mb-2">Account Security</h3>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold text-gray-700 mt-8 mb-4">4. Service Description</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold text-gray-700 mt-8 mb-4">5. Contact Information</h2>
      <p className="mb-4">
