...
import SwitcherTwo from '../../elements/forms/SwitcherTwo';
            ...
            <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
              <div className='border-b border-stroke py-4 px-7 dark:border-strokedark'>
                <h3 className='flex items-center justify-between font-medium text-black dark:text-white'>
                  Lyrics <SwitcherTwo label='Custom' />
                </h3>
              </div>
              <div className='p-7'>
                  ...
                  <div className='mb-5.5'>
                    ...
                    <div className='relative'>
                      ...
                      <textarea
                        ...
                        id='bio'
                        rows={6}
                        placeholder='An upbeat pop song about falling in love at first sight on a summer beach. Catchy chorus with tropical vibes.'
                      ></textarea>
                    </div>
                  </div>
