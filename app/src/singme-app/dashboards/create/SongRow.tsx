...
const SongRow: React.FC<SongRowProps> = ({ song, onSongSelect, isCurrentSong, isPlaying, togglePlay }) => {
        ...
        {song.status.toLowerCase() === 'pending' ? (
          ...
          >
            <div className='w-12 h-12 flex items-center justify-center bg-black bg-opacity-50 rounded-full'>
              {isCurrentSong && isPlaying && !isHovering ? (
                ...
                <svg className='w-10 h-10 text-white' fill='currentColor' viewBox='0 0 20 20'>
                  <path fillRule='evenodd' d={isCurrentSong && isPlaying
